...
exports.putPaciente = exports.getPacientes = exports.getPaciente = exports.deletePaciente = exports.createPaciente = void 0;
...
var getPaciente = exports.getPaciente = /*#__PURE__*/function () {
  ...
  return function getPaciente(_x3, _x4) {
...
//Eliminar paciente
var deletePaciente = exports.deletePaciente = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          _context4.next = 5;
          return connection.query("DELETE FROM pacientes WHERE id_paciente = ?", [req.params.id_paciente]);
        case 5:
          res.sendStatus(204);
        case 6:
        case "end":
  ...
  return function deletePaciente(_x7, _x8) {
...
var putPaciente = exports.putPaciente = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          _context5.next = 5;
          return connection.query("UPDATE pacientes SET ? WHERE id_paciente = ?", [req.body, req.params.id_paciente]);
        case 5:
          _context5.next = 7;
          return connection.query("SELECT * FROM pacientes WHERE id_paciente = ?", [req.params.id_paciente]);
        case 7:
  ...
  return function putPaciente(_x9, _x10) {
