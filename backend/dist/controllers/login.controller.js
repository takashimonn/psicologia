...
exports.verificarCredenciales = void 0;
...
var verificarCredenciales = exports.verificarCredenciales = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, usuario, contrasena, rol, connection, query, idField, _yield$connection$que, _yield$connection$que2, rows, user;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          query = '';
          idField = ''; // Para almacenar el campo de ID correcto
          if (!(rol === 'psicologo')) {
            _context.next = 12;
            break;
          }
